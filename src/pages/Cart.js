      ...
      {products.length > 0 ? (
        <div className="container mx-auto h-auto grid grid-cols-5 gap-8">
          <div className="w-full h-full bg-white px-4 col-span-4">
            <div className="font-titleFont flex item-center justify-between border-b-[1px] border-b-gray-400 py-3">
            ...
            <div onClick={() => dispatch(resetCart())} className="py-2">
          ...
          <div className="w-full h-52 bg-white col-span-1 flex flex-col justify-center items-center p-4">
            ...
            <button className="w-full font-titleFont font-medium text-base bg-gradient-to-tr from-yellow-400 to-yellow-200 border hover:from-yellow-300 hover:to-yellow-500 border-yellow-300  hover:border-yellow-700 active:bg-gradient-to-bl active:from-yellow-400 active:to-yellow-500 duration-200 py-1.5 rounded-md mt-3">
              Proceed to Pay
            </button>
          </div>
        </div>
        ...
        <motion.div
          ...
          <div className="w-96 p-4 bg-white flex flex-col items-center rounded-md shadow-lg">
            ...
            <Link to="/">
              <button className="mt-6 bg-yellow-400 rounded-md cursor-pointer hoover:bg-yellow-500 active:bg-yellow-700 px-8 py-2 font-titleFont font-semibold text-lg">
                Continue Shopping
              </button>
            </Link>
          </div>
